...
function Writer(logger) {
    ...
    /**
     * Creates a potential named `'module.exports[.exportsAs]'` string.
     *
     * @param {string} [exportsAs] - The export name.
     * @returns {Promise}          - Promise resolves with the exports string.
     * @private
     */
    function createExportsString(exportsAs) {
        return new Promise(function (resolve, reject) {
            var exports = 'module.exports';
            if (exportsAs && (typeof exportsAs === 'string') && exportsAs !== '') {
                if (!self.validator.validateIdentifier(exportsAs)) {
                    return reject(new Error('Found invalid identifier for exports: ' + exportsAs));
                }
                exports = exports + '.' + exportsAs + ' = ';
            } else {
                exports = exports + ' = ';
            }
     ...
     * @param {string} [exportsAs] - Name for export (*IMPORTANT:* must be a valid identifier).
     * @returns {Promise}          - Promise resolve with the serialized JS.
     * @private
     */
    function serializeJsToString(json, indent, exportsAs) {
        return createExportsString(exportsAs)
