...
Constants.prototype.ORIGIN_DEFAULT = ': if not given, the type is tried to be inferred from the extension of source path, else it is ' + constants.YAML;

Constants.prototype.TARGET_DEFAULT = ': if not given, the type is tried to be inferred from the extension of destination path, else it is ' + constants.JS;
 ...
 * @property {string} dest='relative to input file'   - The default dest description.
