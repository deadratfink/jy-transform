 ...
 *
 * @type {{yaml2js: yamlToJs, yaml2json: yamlToJs, js2yaml: jsToYaml, json2yaml: jsToYaml, json2js: jsonToJs, js2json: jsToJson, yaml2yaml: *, json2json: *, js2js: *}}
 * @private
 */
var transformations = {
    yaml2js: yamlToJs,
...
function yamlToJs(options, middleware) {
    ...
    return reader.readYaml(options.src, 'utf8')
...
function jsToYaml(options, middleware) {
    var read = (options.origin === Constants.JSON) ? reader.readJson : reader.readJs;
...
function jsonToJs(options, middleware) {
    return reader.readJson(options.src)
        .then(ensureMiddleware(middleware))
        .then(function (json) {
